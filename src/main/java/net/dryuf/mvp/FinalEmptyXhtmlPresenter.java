 ...
 */
public class FinalEmptyXhtmlPresenter extends net.dryuf.mvp.EmptyXhtmlPresenter
{
	public				FinalEmptyXhtmlPresenter(Presenter parentPresenter, Options options)
	{
