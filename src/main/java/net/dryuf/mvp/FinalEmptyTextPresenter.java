 ...
 */
public class FinalEmptyTextPresenter extends net.dryuf.mvp.FinalMainPresenter
{
	public				FinalEmptyTextPresenter(Presenter parentPresenter_, Options options)
	{
