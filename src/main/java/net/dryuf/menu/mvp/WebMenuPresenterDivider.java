...
public class WebMenuPresenterDivider extends AbstractPresenterDivider implements AppContainerAware
{
	public				WebMenuPresenterDivider()
	{
	}
	...
	public int			checkPage(Presenter presenter, String page)
	{
		...
		WebAccessiblePage impl = webAccessiblePageDao.loadByPageCode(webProvider, page);
		if (impl != null) {
