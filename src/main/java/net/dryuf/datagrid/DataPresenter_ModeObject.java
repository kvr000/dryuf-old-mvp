...
public class DataPresenter_ModeObject <T> extends net.dryuf.datagrid.DataPresenter_SubMode<T>
{
	public				DataPresenter_ModeObject(net.dryuf.mvp.Presenter parentPresenter, net.dryuf.core.Options options)
	{
