...
public class DataPresenter_ModeEdit <T> extends net.dryuf.datagrid.DataPresenter_ModeSingle<T>
{
	public				DataPresenter_ModeEdit(Presenter parentPresenter, Options options)
	{
	...
	{
		this.outputFormat(
			"<div id=\"net-dryuf-datagrid-DataPresenter-edit\">\n"+
			"<script type=\"text/javascript\">\n"+
			"net.dryuf.requireAsync(function() {\n"+
			"		new net.dryuf.datagrid.DataGridPresenter(\n"+
			"			null,\n"+
			"			document.getElementById(\"net-dryuf-datagrid-DataPresenter-edit\"),\n"+
			"			{\n"+
			"				dataClassName:		%J,\n"+
			"				mode:			'edit',\n"+
			"				objKey:			%s,\n"+
