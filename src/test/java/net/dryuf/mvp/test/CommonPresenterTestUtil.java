...
public abstract class CommonPresenterTestUtil
{
	public static RootPresenter	createPresenter(CallerContext callerContext, String path, Map<String, String> params)
	{
		DummyRequest testRequest = new DummyRequest();
		if (params != null)
			testRequest.addParams(params);
		testRequest.setPath(path);
		return new TextRootPresenter(callerContext, testRequest);
	}
}
